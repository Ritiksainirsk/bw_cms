...
const Login = () => {
  ...
  const {
    ...
    handleSubmit,
    setValue,
    trigger, // Trigger is destructured here
    formState: { errors },
  } = useForm({
  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      trigger(); // Use trigger directly here
    }, 100);
  ...
  const onSuccessLogin = async (res) => {
    ...
    localStorage.setItem(
      Const.LoggedInRolePermission,
      JSON.stringify(res.role)
    );
                ...
                >
                  ...
                  <div className="form-outline mb-4">
                    ...
                    <div className="d-flex">
                      <input
                        ...
                        className={`${
                          errors.password
                            ? `form-control pass-view error-outline`
                            : `form-control pass-view`
                        }`}
                      ...
                      <span className="input-group-append">
                        <button
                          ...
                          className={`${
                            errors.password
                              ? `search-append error-outline btn btn-bg`
                              : `search-append btn btn-bg`
                          }`}
                        >
                          {showPassword ? (
                            <FiEye
                  ...
                  <div className="form-outline d-flex justify-content-between mb-4">
                    ...
                    <div className="text-right">
                      <Link href={"/forgetpassword"} className="forgot">
                        Forgot password
                      </Link>
                    </div>
                  </div>
