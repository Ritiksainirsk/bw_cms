...
const PageListTable = ({columns, rows, handleStatusAction, handleAddEditToggle, isPermission, handleDuplicate, isLoadMore, handleLoadMore, setRowsId, handleEditContent, handleEditComponent }) => {
