...
const ComponentSetting = ({itemList, handleChecked, handleDrop, saveTableSetting, handleUpdatePermissionToggle}) => {
  return (
    <div className="offcanvas offcanvas-end" data-bs-scroll="true" tabIndex="-1" id="componentsetting" aria-labelledby="offcanvasRightLabel">
        <div className="offcanvas-header">
            <h5 className="offcanvas-title" id="offcanvasWithBothOptionsLabel">Component Setting</h5>
